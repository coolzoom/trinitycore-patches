...
{
if (!pPlayer->HasItemCount((sConfig->GetIntDefault("ProfessionNPC.ItemEntryNum",0)), 1))
{
    pPlayer->CLOSE_GOSSIP_MENU();
    pCreature->MonsterWhisper("You ain't gots no darn chips.", pPlayer->GetGUID());
	return;
}
else if(pPlayer->GetMoney() < (sConfig->GetIntDefault("SkillGoldCost",0)))
{
    pPlayer->CLOSE_GOSSIP_MENU();
...
case 1001: // Alchemy
	...
	pPlayer->UpdateSkill(171,(sConfig->GetIntDefault("SkillPoints",0)));
	if(sConfig->GetBoolDefault("ProfessionNPC.UseTokens", true))
	pPlayer->DestroyItemCount(99999, 1, true);
	else
	pPlayer->ModifyMoney(-(sConfig->GetIntDefault("SkillGoldCost",0)));
	pPlayer->CLOSE_GOSSIP_MENU();
break;
...
case 1002: // Blacksmithing
	...
	pPlayer->UpdateSkill(164,(sConfig->GetIntDefault("SkillPoints",0)));
	if(sConfig->GetBoolDefault("ProfessionNPC.UseTokens", true))
	pPlayer->DestroyItemCount(99999, 1, true);
	else
	pPlayer->ModifyMoney(-(sConfig->GetIntDefault("SkillGoldCost",0)));
...
case 1003: // Enchanting
	...
	pPlayer->UpdateSkill(333,(sConfig->GetIntDefault("SkillPoints",0)));
	if(sConfig->GetBoolDefault("ProfessionNPC.UseTokens", true))
	pPlayer->DestroyItemCount(99999, 1, true);
	else
	pPlayer->ModifyMoney(-(sConfig->GetIntDefault("SkillGoldCost",0)));
...
case 1004: // Engineering
	...
	pPlayer->UpdateSkill(202,(sConfig->GetIntDefault("SkillPoints",0)));
	if(sConfig->GetBoolDefault("ProfessionNPC.UseTokens", true))
	pPlayer->DestroyItemCount(99999, 1, true);
	else
	pPlayer->ModifyMoney(-(sConfig->GetIntDefault("SkillGoldCost",0)));
...
case 1005: // Herbalism
	...
	pPlayer->UpdateSkill(182,(sConfig->GetIntDefault("SkillPoints",0)));
	if(sConfig->GetBoolDefault("ProfessionNPC.UseTokens", true))
	pPlayer->DestroyItemCount(99999, 1, true);
	else
	pPlayer->ModifyMoney(-(sConfig->GetIntDefault("SkillGoldCost",0)));
...
case 1006: // Inscription
	...
	pPlayer->UpdateSkill(773,(sConfig->GetIntDefault("SkillPoints",0)));
	if(sConfig->GetBoolDefault("ProfessionNPC.UseTokens", true))
	pPlayer->DestroyItemCount(99999, 1, true);
	else
	pPlayer->ModifyMoney(-(sConfig->GetIntDefault("SkillGoldCost",0)));
...
case 1007: // Jewelcrafting
	...
	pPlayer->UpdateSkill(755,(sConfig->GetIntDefault("SkillPoints",0)));
	if(sConfig->GetBoolDefault("ProfessionNPC.UseTokens", true))
	pPlayer->DestroyItemCount(99999, 1, true);
	else
	pPlayer->ModifyMoney(-(sConfig->GetIntDefault("SkillGoldCost",0)));
...
case 1008: // Leatherworking
	...
	pPlayer->UpdateSkill(165,(sConfig->GetIntDefault("SkillPoints",0)));
	if(sConfig->GetBoolDefault("ProfessionNPC.UseTokens", true))
	pPlayer->DestroyItemCount(99999, 1, true);
	else
	pPlayer->ModifyMoney(-(sConfig->GetIntDefault("SkillGoldCost",0)));
...
case 1009: // Mining
	...
	pPlayer->UpdateSkill(186,(sConfig->GetIntDefault("SkillPoints",0)));
	if(sConfig->GetBoolDefault("ProfessionNPC.UseTokens", true))
	pPlayer->DestroyItemCount(99999, 1, true);
	else
	pPlayer->ModifyMoney(-(sConfig->GetIntDefault("SkillGoldCost",0)));
...
case 1010: // Skinning
	...
	pPlayer->UpdateSkill(393,(sConfig->GetIntDefault("SkillPoints",0)));
	if(sConfig->GetBoolDefault("ProfessionNPC.UseTokens", true))
	pPlayer->DestroyItemCount(99999, 1, true);
	else
	pPlayer->ModifyMoney(-(sConfig->GetIntDefault("SkillGoldCost",0)));
...
case 1011: // Tailoring
	...
	pPlayer->UpdateSkill(197,(sConfig->GetIntDefault("SkillPoints",0)));
	if(sConfig->GetBoolDefault("ProfessionNPC.UseTokens", true))
	pPlayer->DestroyItemCount(99999, 1, true);
	else
	pPlayer->ModifyMoney(-(sConfig->GetIntDefault("SkillGoldCost",0)));
...
case 2001: // Cooking
	...
	pPlayer->UpdateSkill(185,(sConfig->GetIntDefault("SkillPoints",0)));
	if(sConfig->GetBoolDefault("ProfessionNPC.UseTokens", true))
	pPlayer->DestroyItemCount(99999, 1, true);
	else
	pPlayer->ModifyMoney(-(sConfig->GetIntDefault("SkillGoldCost",0)));
...
case 2002: // First Aid
	...
	pPlayer->UpdateSkill(129,(sConfig->GetIntDefault("SkillPoints",0)));
	if(sConfig->GetBoolDefault("ProfessionNPC.UseTokens", true))
	pPlayer->DestroyItemCount(99999, 1, true);
	else
	pPlayer->ModifyMoney(-(sConfig->GetIntDefault("SkillGoldCost",0)));
...
case 2003: // Fishing
	...
	pPlayer->UpdateSkill(356,(sConfig->GetIntDefault("SkillPoints",0)));
	if(sConfig->GetBoolDefault("ProfessionNPC.UseTokens", true))
	pPlayer->DestroyItemCount(99999, 1, true);
	else
	pPlayer->ModifyMoney(-(sConfig->GetIntDefault("SkillGoldCost",0)));
