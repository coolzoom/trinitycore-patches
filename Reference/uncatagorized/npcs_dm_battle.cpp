...
bool GossipHello_npc_dire_arena_commander(Player * player, Creature * creature)
{
...
bool GossipSelect_npc_dire_arena_commander(Player * player, Creature * creature, uint32 sender, uint32 actions)
{
...
CreatureAI * GetAI_npc_dire_arena_commander(Creature * pCreature) const
{
...
CreatureAI * GetAI_npc_dire_maul_rb_guard(Creature * pCreature) const
{
...
CreatureAI * GetAI_npc_red_blood_mini(Creature * pCreature) const
{
...
CreatureAI * GetAI_npc_dm_wave_trigger(Creature * pCreature) const
{
...
CreatureAI * GetAI_npc_dm_wave_spawns(Creature * pCreature) const
{
...
CreatureAI * GetAI_npc_dm_wave_portals(Creature * pCreature) const
{
...
CreatureAI * GetAI_npc_dm_hank_the_tank(Creature * pCreature) const
{
...
CreatureAI * GetAI_npc_dm_field_medic(Creature * pCreature) const
{
...
CreatureAI * GetAI_npc_dm_main_rogue(Creature * pCreature) const
{
...
CreatureAI * GetAI_npc_dm_rogue_initiate(Creature * pCreature) const
{
...
CreatureAI * GetAI_npc_dm_main_unholy(Creature * pCreature) const
{
...
CreatureAI * GetAI_npc_dm_unholy_twin(Creature * pCreature) const
{
...
CreatureAI * GetAI_npc_dm_unholy_pet(Creature * pCreature) const
{
...
CreatureAI * GetAI_npc_army_ghoul(Creature * pCreature) const
{
...
CreatureAI * GetAI_npc_dm_rider_guardian(Creature * pCreature) const
{
...
CreatureAI * GetAI_npc_dm_rider_brute(Creature * pCreature) const
{
...
CreatureAI * GetAI_npc_dm_dragon_final(Creature * pCreature) const
{
...
void AddSC_arena_link_battle()
{
    ...
    pNewScript->Name = "npc_dire_arena_commander";
    pNewScript->pGossipHello = &GossipHello_npc_dire_arena_commander;
    pNewScript->pGossipSelect = &GossipSelect_npc_dire_arena_commander;
    pNewScript->GetAI = &GetAI_npc_dire_arena_commander;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_dire_maul_rb_guard";
    pNewScript->GetAI = &GetAI_npc_dire_maul_rb_guard;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_red_blood_mini";
    pNewScript->GetAI = &GetAI_npc_red_blood_mini;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_dm_wave_trigger";
    pNewScript->GetAI = &GetAI_npc_dm_wave_trigger;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_dm_wave_spawns";
    pNewScript->GetAI = &GetAI_npc_dm_wave_spawns;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_dm_hank_the_tank";
    pNewScript->GetAI = &GetAI_npc_dm_hank_the_tank;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_dm_field_medic";
    pNewScript->GetAI = &GetAI_npc_dm_field_medic;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_dm_main_rogue";
    pNewScript->GetAI = &GetAI_npc_dm_main_rogue;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_dm_rogue_initiate";
    pNewScript->GetAI = &GetAI_npc_dm_rogue_initiate;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_dm_main_unholy";
    pNewScript->GetAI = &GetAI_npc_dm_main_unholy;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_dm_unholy_twin";
    pNewScript->GetAI = &GetAI_npc_dm_unholy_twin;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_dm_unholy_pet";
    pNewScript->GetAI = &GetAI_npc_dm_unholy_pet;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_army_ghoul";
    pNewScript->GetAI = &GetAI_npc_army_ghoul;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_dm_rider_guardian";
    pNewScript->GetAI = &GetAI_npc_dm_rider_guardian;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_dm_rider_brute";
    pNewScript->GetAI = &GetAI_npc_dm_rider_brute;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_dm_dragon_final";
    pNewScript->GetAI = &GetAI_npc_dm_dragon_final;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "npc_dm_wave_portals";
    pNewScript->GetAI = &GetAI_npc_dm_wave_portals;
    pNewScript->RegisterSelf();

	/* Player Classes */

    pNewScript = new Script;
    pNewScript->Name = "remove_non_battle_player";
    pNewScript->GetAI = &GetAI_remove_non_battle_player;
    pNewScript->RegisterSelf();
}