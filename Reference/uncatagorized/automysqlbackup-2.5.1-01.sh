...
#=====================================================================
#set -x
CONFIGFILE="/opt/automysqlbackup/automysqlbackup.conf"
...
if [ -r ${CONFIGFILE} ]; then
	...
	DBNAMES="armory auth blizzlike cataauth cataworld characterbl characterscata charactersdev charactersfl darkpsyon devworld dpwebwow flamingcore flamingcoredbc flamingworld magisch mmfpm mmftc realmd samccstudios torrentflux torrentfluxb4rt webwow webwowv2 world"
	
	# Backup directory location e.g /backups
	BACKUPDIR="/opt/autobackup/db"
	...
	MAILADDR="samccstudios@gmail.com"
