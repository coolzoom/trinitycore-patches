...
public:
	...
	bool OnGossipHello(Player* player, Creature* creature)
	{
		...
		if (sConfigMgr->GetBoolDefault("Server.Helper.Enable", true))
		{
			player->PlayerTalkClass->ClearMenus();
	...
	bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action)
	{
		...
		case SKILLS_MENU:
			...
			break;
		case TELEPORT_MENU:
			if (sConfigMgr->GetBoolDefault("Server.Helper.Teleport.Menu.Enable", true))
			{
				player->PlayerTalkClass->ClearMenus();
		...
		case DATA_AREA_52:
			...
			break;
		case BUFF_MENU:
			if (sConfigMgr->GetBoolDefault("Server.Helper.Buff.Menu.Enable", true))
			{
				player->PlayerTalkClass->ClearMenus();
		...
		case ACTION_WATER_BREATHING:
			...
			break;
		case CUSTOMIZE_MENU:
			if (sConfigMgr->GetBoolDefault("Server.Helper.Customize.Menu.Enable", true))
			{
				player->PlayerTalkClass->ClearMenus();
		...
		case ACTION_CHANGE_RACE:
			...
			break;
		case EXCHANGE_MENU:
			if (sConfigMgr->GetBoolDefault("Server.Helper.Exchange.Menu.Enable", true))
			{
				player->PlayerTalkClass->ClearMenus();
		...
		case ACTION_FROST_TO_STONE_KEEPERS_SHARD:
			...
			break;
		case MOVIE_MENU:
			if (sConfigMgr->GetBoolDefault("Server.Helper.Movie.Menu.Enable", true))
			{
				player->PlayerTalkClass->ClearMenus();
		...
		case ACTION_MOVIE_FALL_OF_THE_LICH_KING:
			...
			break;
		case FUNNY_MENU:
			if (sConfigMgr->GetBoolDefault("Server.Helper.Funny.Menu.Enable", true))
			{
				player->PlayerTalkClass->ClearMenus();
