...
enum SpellIds
{
	...
	/* `- Spore Healer */
	SPELL_HEAL_REGROWTH = 26980, //heal+H.O.T.
	SPELL_HEAL_NORMAL = 34119, //heal normal
	SPELL_HEAL_REJUV = 38324, //H.O.T.
	SPELL_HEAL_AURA_HOTS = 38299, // Aura hots
	SPELL_FLASH_HEAL = 25235,
	SPELL_POWER_WORD_SHIELD = 20697, // Absorbs a ton of damage
	SPELL_HEAL_LIFEBLOOM = 33763,
	/* `- Hank the Tank */
	SPELL_BATTLE_STANCE = 2487, //warrior bstance
	SPELL_SHOUT_BUFF = 25289,	//attk pwr self buff
	SPELL_TANK_CHARGE = 11578,	//warrior charge
	SPELL_GROUND_STOMP = 23931, //thunderclap
	SPELL_EXECUTE = 38959,		//normal strike
	SPELL_TANK_STRIKE = 43298,	//normal strike
	SPELL_INCREASE_BLOCK_VALUE = 18064, // Increases block value
	SPELL_SHIELD_BLOCK = 32587, // Blocks attacks
	SPELL_INCREASE_DEFENSE_RATING = 24774, // Increases Defense by 180+
	SPELL_INCREASE_DODGE_RATING = 18062, // Increase dodge by 96
	SPELL_REND = 25208, // Rends the target ~Bleeds
	SPELL_SHIELD_BASH = 29704, // Bashes the target with a shield
	/* Second Wave Spells */
	SPELL_ROGUE_STEALTH = 1784,
	SPELL_ROGUE_CHEAP_SHOT = 1833, //in stealth only
	SPELL_ROGUE_STRIKE = 26862,
	SPELL_ROGUE_FINISHER = 26865,
	SPELL_ROGUE_VANISH = 26889, //idea here is to make the sidekicks(and main?) vanish in/out of the fight
	SPELL_ROGUE_KICK = 27814,
	SPELL_ROGUE_BACKSTAB = 26863,
	SPELL_ROGUE_RUPTURE = 26867,
	SPELL_ROGUE_KIDNEY_SHOT = 41389,
	/* Second Wave Treat Spells */
	SPELL_UNHOLY_BONE_SHIELD = 25472,
	SPELL_UNHOLY_AOE = 27212,
	SPELL_UNHOLY_PLAGUE_STRIKE = 30335,
	SPELL_UNHOLY_STANGULATE = 36471,
	SPELL_UNHOLY_DEATH_STRIKE = 40358,
	SPELL_UNHOLY_ARMY = 42650, // <- should happen with both NPC's simultaneously
	SPELL_ENRAGE = 24318,
	/* Second Wave Elite Spells */
	/*	`- Rider Brutes	*/
	SPELL_RIDERS_LIGHTNING = 39580, // aoe
	SPELL_RIDERS_CHAIN_LIGHTNING = 25442, // aoe
	SPELL_RIDERS_MOONFIRE = 20690,
	SPELL_RIDERS_STORM = 39365, // aoe
	/*	`- Rider Healer	*/
	SPELL_RIDERS_STAM_BUFF = 14483, // fortitude buff
	SPELL_RIDERS_SHIELD = 23991, // absorbs damage
	SPELL_RIDERS_HEALING_BOLT = 37455,
	SPELL_RIDERS_RENEW = 25222,
	SPELL_RIDERS_GREATER_HEAL = 25213,
	/* Final Wave Boss Spells */
	SPELL_DRAGON_FIRE_SHIELD = 30514, //Reduces damage by 95% for 5s
	SPELL_DRAGON_ENGULF = 20019,
	SPELL_DRAGON_BREATH = 29964,
	SPELL_DRAGON_TAIL_WHIP = 38737,
	SPELL_DRAGON_BERSERK = 35595,
	SPELL_DRAGON_CLAW = 24187,
	SPELL_DRAGON_MASSIVE_FLAMESTRIKE = 27086,
...
void MessageOnWave(Creature * me, uint32 eventId)
{
	...
	me->MonsterYell(ss.str().c_str(), LANG_UNIVERSAL, me->GetObjectGuid());
}
