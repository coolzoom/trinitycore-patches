...
PlayerbotMgr::PlayerbotMgr(Player* const master) : m_master(master)
{
    ...
    m_confSharedBots = botConfig.GetBoolDefault("PlayerbotAI.SharedBots", true);
    m_confDisableBots = botConfig.GetBoolDefault("PlayerbotAI.DisableBots",true);
}
...
{
    if (botConfig.GetBoolDefault("PlayerbotAI.DisableBots",true))
    {
