...
bool BattlegroundWS::SetupBattleground()
{
    ...
    {
        TC_LOG_ERROR("bg.battleground", "BatteGroundWS: Failed to spawn some object Battleground not created!");
        return false;
    }
    ...
    {
        TC_LOG_ERROR("bg.battleground", "BatteGroundWS: Failed to spawn Alliance spirit guide! Battleground not created!");
        return false;
    }
    ...
    {
        TC_LOG_ERROR("bg.battleground", "BatteGroundWS: Failed to spawn Horde spirit guide! Battleground not created!");
        return false;
    }
